...
@UntilDestroy()
@Component({
  selector: 'cc-create-equipment',
  template: `
    <div class='illustration'
         style='background-image: url("https://via.placeholder.com/400x600.png/09f/fff?text=une+caisse+a+outils")'>
    </div>
  ...
  providers: [CreateEquipmentFacadeService]
})
export class CreateEquipmentComponent {

  constructor(public readonly facade: CreateEquipmentFacadeService, private router: Router, private route: ActivatedRoute) {
